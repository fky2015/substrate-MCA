...
/// Contains the inherents for the JASMINE module
use sp_inherents::{Error, InherentData, InherentIdentifier};

/// The Jasmine inherent identifier.
pub const INHERENT_IDENTIFIER: InherentIdentifier = *b"auraslot";

/// The type of the Jasmine inherent.
pub type InherentType = sp_consensus_slots::Slot;

/// Auxiliary trait to extract Jasmine inherent data.
pub trait JasmineInherentData {
...
impl JasmineInherentData for InherentData {
	fn aura_inherent_data(&self) -> Result<Option<InherentType>, Error> {
...
/// Provides the slot duration inherent data for `Jasmine`.
