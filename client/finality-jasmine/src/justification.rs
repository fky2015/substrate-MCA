...
pub struct JasmineJustification<Block: BlockT> {
	view: u64,
	pub(crate) f_commit: FinalizedCommit<Block>,
}

impl<Block: BlockT> JasmineJustification<Block> {
	...
	) -> Result<JasmineJustification<Block>, Error>
	where
		C: HeaderBackend<Block>,
	{
		Ok(JasmineJustification { view, f_commit })
	}
