...
use sc_consensus_events::{check_equivocation, CheckedHeader, InherentDataProviderExt};
...
/// A verifier for Jasmine blocks.
pub struct JasmineVerifier<C, P, CAW, CIDP> {
	client: Arc<C>,
...
impl<C, P, CAW, CIDP> JasmineVerifier<C, P, CAW, CIDP> {
	pub(crate) fn new(
		client: Arc<C>,
		create_inherent_data_providers: CIDP,
		can_author_with: CAW,
...
/// Start an import queue for the Jasmine consensus algorithm.
...
) -> JasmineVerifier<C, P, CAW, CIDP> {
	JasmineVerifier::<_, P, _, _>::new(
		client,
		create_inherent_data_providers,
		can_author_with,
		check_for_equivocation,
