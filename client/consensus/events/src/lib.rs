...
const IN_BETWEEN_BLOCK_IDENTIFIER: InherentIdentifier = *b"ibtblock";
/// The lower bound of how many transactions we should have in a in-between block.
const MINIMAL_TRANSACTION_NUMBER: usize = 0;

// pub struct InBetweenBlockInherentDataProvider {
// 	is_in_between_block: bool,
// }
//
// impl InBetweenBlockInherentDataProvider {
// 	pub fn new(is_in_between_block: bool) -> Self {
// 		Self { is_in_between_block }
// 	}
// }
//
// #[async_trait::async_trait]
// impl sp_inherents::InherentDataProvider for InBetweenBlockInherentDataProvider {
// 	fn provide_inherent_data(&self, inherent_data: &mut InherentData) -> Result<(), Error> {
// 		inherent_data.put_data(IN_BETWEEN_BLOCK_IDENTIFIER, &self.is_in_between_block)
// 	}
//
